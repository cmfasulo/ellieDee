...
<ul>
  <li>
   <strong>July 2016:</strong> Initially designed (read: "struggled immensely") prior to any serious programming knowledge, created Google        Play store app with MIT App Inventor tools.
  </li>
  <li>
